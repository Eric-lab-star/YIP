...
const slides: Slide[] = [
  { title: "", bg: "from-purple-50 to-pink-50", script: "안녕하세요, 여러분. 오늘은 지난 시간의 글 생성 기능에 이미지 묘사 생성을 합쳐 완성형 블로그 앱을 만드는 실습을 진행하겠습니다. 2가지 미션을 약 25~30분에 걸쳐 수행합니다.", content: (<div className="flex flex-col items-center justify-center h-full gap-6 text-center"><span className="text-8xl">🎨</span><h1 className="text-5xl sm:text-6xl font-bold text-gray-800">블로그 앱 실습 (2부)</h1><p className="text-2xl text-gray-500 mt-2">글과 이미지 묘사 합치기</p></div>) },
