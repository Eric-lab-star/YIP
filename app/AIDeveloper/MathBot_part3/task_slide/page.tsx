...
const slides: Slide[] = [
  ...
  },
  {
    ...
    script: "미션 1의 핵심 포인트입니다. 우리가 기능을 처음부터 하나로 뭉쳐서 만들지 않고, 따로따로 만든 다음 마지막에 합친 이유가 있습니다. 이런 방식을 '모듈식 개발'이라고 합니다. 모듈식 개발의 장점은 세 가지입니다. 첫째, 각 부품을 따로 테스트할 수 있어서 오류를 찾기 쉽습니다. 둘째, 문제가 생겼을 때 어느 부품에서 잘못되었는지 빠르게 파악할 수 있습니다. 셋째, 14차시의 풀이 기능을 오늘 그대로 재사용하는 것처럼, 한 번 잘 만든 부품은 계속 활용할 수 있습니다.",
    content: (
      <div className="flex flex-col gap-6">
  ...
  },
  {
    ...
    script: "오늘 3가지 미션을 모두 수행하셨습니다. 정리하겠습니다. 미션 1에서는 13차시와 14차시의 코드를 한 파일에 모으는 구조를 파악했습니다. 미션 2에서는 사진 핸들러를 추가하여 사진을 받아 풀이를 답장하는 핵심 기능을 완성했습니다. 미션 3에서는 실제 텔레그램에서 봇을 테스트하여 전체 파이프라인이 작동하는 것을 확인했습니다. 이것은 모듈식 개발의 실제 적용 사례이기도 합니다. 다음 시간에는 이 경험을 바탕으로 영어 대화 연습 앱을 만들어보겠습니다.",
    content: (
      <div className="flex flex-col gap-5">
        <div className="space-y-3">
          {[
