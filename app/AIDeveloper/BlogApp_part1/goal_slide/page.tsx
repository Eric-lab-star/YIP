...
const slides: Slide[] = [
  { title: "", bg: "from-amber-50 to-orange-50", script: "안녕하세요, 여러분. 오늘은 주제 하나만 입력하면 AI가 블로그 글을 통째로 써주는 앱을 만들어보겠습니다. '초보자를 위한 홈카페 만들기' 같은 주제만 입력하면 제목부터 본문까지 짜임새 있는 글이 자동으로 생성됩니다. 그 비밀은 바로 '프롬프트 설계'에 있습니다. 함께 알아보겠습니다.", content: (<div className="flex flex-col items-center justify-center h-full gap-6 text-center"><h1 className="text-5xl sm:text-6xl font-bold text-gray-800 leading-tight">블로그 글쓰기 앱 (1부)</h1><p className="text-2xl text-gray-500 mt-2">설계도부터 그리는 블로그 글쓰기</p></div>) },
...
structure = client.models.generate_content(
  ...
  { title: "", bg: "from-amber-50 to-orange-50", script: "오늘 강의를 마치겠습니다. AI에게 글의 설계도부터 그리게 하는 방법을 배웠습니다. 이제 실습에서 직접 빈칸을 채우며 블로그 글 생성 앱을 만들어보겠습니다. 수고하셨습니다.", content: (<div className="flex flex-col items-center justify-center h-full gap-6 text-center"><h1 className="text-5xl font-bold text-gray-800">개념 강의를 마칩니다</h1><p className="text-xl text-gray-600 mt-4">다음: 블로그 글 생성 앱 실습</p><p className="text-2xl text-gray-500 mt-4">수고하셨습니다!</p></div>) },
];
