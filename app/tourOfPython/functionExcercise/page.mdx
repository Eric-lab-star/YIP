...
export const metadata = {
  title: "함수 연습하기 · Level 1",
  description: "함수의 이름, 실행 방법, return, 매개변수에 대한 개념 확인 문제를 풀어봐요.",
};
...
`} />
  ...
  <Option value={2}>width와 height는 createBox 안에서만 사용할 수 있다.</Option>
...
<QuizzWithOptions answer={2} question="6. 다음 설명 중 틀린 것을 고르세요.">
  <CodeBlock code={`def ice_maker(str):
    return "ice " + str
