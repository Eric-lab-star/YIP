...
print(fibonacci(9)) `
		...
		<Image className="mx-auto"alt="django logo" src={`${process.env.R2_CUSTOM}/django.png`} width={400} height={400} />
		<Text my="l">
		...
		<Image className="mx-auto"alt="django logo" src={`${process.env.R2_CUSTOM}/pygame_logo.png`} width={400} height={400} />
		...
		<Image className="mx-auto"  src={`${process.env.R2_CUSTOM}/micropython_logo.png`} width={400} height={400} alt="micropython"/>
		<Text my="l">
