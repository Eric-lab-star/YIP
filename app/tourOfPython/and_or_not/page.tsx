...
export default async function Page() {
	...
	return (
		<div className="mb-50">
			<Link href={"/tourOfPython/and_or_not#title"} id={"title"}>
			...
			<Link id={"and"} href={"/tourOfPython/and_or_not#and"}>
				<Title>and</Title>
			</Link>
			<TwoColumn>
				<CodeBlock code={
...
`} />
			...
			<Link href={"/tourOfPython/and_or_not#or"} id={"or"}>
...
`} />
			...
			<Link href={"/tourOfPython/and_or_not#not"} id={"not"}>
