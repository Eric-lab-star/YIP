...
export default async function Page() {
	...
	return (
		<div className="space-y-5 mb-50">
			<Link id={"title"} href={"/tourOfPython/variable_string_boolean#title"}>
				<Title> 변수, 문자열, 불리안 </Title>
			</Link>

			<Link id={"variable"} href={"/tourOfPython/variable_string_boolean#variable"}>
...
@age_10 = 10 # 불가능 - 특수문자를 입력하면 안됨`}>
			...
			<Link id="string" href={"/tourOfPython/variable_string_boolean#string"}>
...
`}>
			...
			<Link id="boolean" href={"/tourOfPython/variable_string_boolean#boolean"}>
				<Title weight="semi" size="h2">🦁 불리언 boolean</Title>
			</Link>
...
`}>
			...
			<Link id="quizz" href={"/tourOfPython/variable_string_boolean#quizz"}>
