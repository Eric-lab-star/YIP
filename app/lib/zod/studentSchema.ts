...
export type DayType = z.infer<typeof DayEnum >
...
const ClassDayItems= z.object({id: z.uuidv4(), day: DayEnum, start: TimeSchema, end: TimeSchema})
export type ClassDayItemsType = z.infer<typeof ClassDayItems>

const ClassDays = z.array(ClassDayItems)
export type ClassDaysType = z.infer<typeof ClassDays>
