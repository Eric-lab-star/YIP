...
const ClassDayEntries = z.tuple([ DayEnum, z.object({start: TimeSchema, end: TimeSchema})])
export type ClassDayEntriesType = z.infer<typeof ClassDayEntries>
...
const studentSchema =  z.object({
	...
	classDays: z.array(ClassDayEntries).min(1, "1개 이상필요"),
